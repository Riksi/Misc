...
//    Rep invariant:
//      Receive connections from >= 1 player(s) and handle their requests 
//      concurrently in a threadsafe manner
//
//    Abstraction function:
//      Represents a system which runs a multiplayer minesweeper game
//      according the Minesweeper Protocol, using a Board instance and 
//      a debug setting. Receives connections from >=1 players and handles
//      their messages
//      
//    Safety from rep exposure
//      -All fields are private and final
//      -The board field is mutable but no references are leaked to it outside
//      since it a defensive copy is made and it is shared only with objects
//      references to whom reside entirely within the server object and 
//      are not shared outside.
//      -The serverSocket field is also mutable but it is initialised within
//      board and no references are shared outside 
//    
...
//       in the immutable MinesweeperMessage container class.
     ...
     * @param board Board instance, which must be unplayed 
