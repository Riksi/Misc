...
public class PublishedTest {
    ...
    private static final String BOARDS_PKG = "";
    ...
    public void publishedTest() throws IOException {
        ...
        assertTrue("expected HELLO message", in.readLine().equals("Welcome to Minesweeper. "
            + "Players: 1 including you. Board: 7 columns by 7 rows. Type 'help' for help."));
        ...
        out.println("DIG 6");
        assertEquals("https://en.wikipedia.org/wiki/Minesweeper_(video_game)", in.readLine());
